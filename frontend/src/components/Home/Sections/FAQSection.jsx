...
const FAQItem = ({ question, answer, isOpen, onToggle }) => {
    return (
        <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200 hover:border-orange-300 transition-all">
            <button
                onClick={onToggle}
                className="w-full text-left font-bold text-lg text-gray-900 flex items-center gap-3 focus:outline-none"
            >
                <svg
...
const FAQSection = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer:
                "Yes, regular workshops and expert talks are conducted to enhance technical knowledge."
        },
        // {
        //     question: "Students can also raise their queries?",
        //     answer:
        //         "Yes, students can submit their queries using the contact form available on the website."
        // }
        //will be implemented later when we add the page to contact us
    ];
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600">
                        Here are some commonly asked questions by students.
                    </p>
                </div>
